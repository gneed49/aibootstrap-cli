...
export function printHelpOverview(): void {
  ...
  console.log("\nMain commands:");
  console.log(chalk.green("  aib init [directory] [options]"));
  console.log(
